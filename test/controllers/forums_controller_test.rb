...
class ForumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum" do
    assert_difference('Forum.count') do
      post forums_url, params: { forum: { description: @forum.description, issue: @forum.issue } }
    end
  ...
  test "should update forum" do
    patch forum_url(@forum), params: { forum: { description: @forum.description, issue: @forum.issue } }
